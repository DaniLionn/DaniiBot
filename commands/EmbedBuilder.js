...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (interaction.options.getString('field1-title') != undefined && interaction.options.getString('field1-content') != undefined) {
        ...
        if (interaction.options.getString('field2-title') != undefined && interaction.options.getString('field2-content') != undefined) {
            exampleEmbed.addFields({
        ...
        if (interaction.options.getString('field3-title') != undefined && interaction.options.getString('field3-content') != undefined) {
            exampleEmbed.addFields({
